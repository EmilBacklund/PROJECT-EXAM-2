...
function RemoveFromFavorite({ open, setOpen }) {
                  ...
                  <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        Are you sure you want to remove this as a favorite? It
                        will be removed from your Dream Stay list and in any
                        Dream Stay collection.
                      </p>
                    </div>
                  </div>
                </div>
