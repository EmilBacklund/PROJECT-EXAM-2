              ...
              <div className='md:w-full bg-black md:bg-opacity-30 bg-opacity-40 text-white'>
                <div className='max-w-4xl mx-auto py-2 md:py-10 px-2 sm:px-4 md:0'>
                  ...
                  <p className='text-sm md:text-base'>
                    At Holidaze, you can find thousands of cottages, houses, and apartments that you
                    can rent directly from the owners - without any hassle. Renting is easy: simply
                    locate a property using our search function, and then contact the owner directly
